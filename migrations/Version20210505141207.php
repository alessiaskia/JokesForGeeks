 ...
 */
final class Version20210505141207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE gadget (id INT AUTO_INCREMENT NOT NULL, sample_picture VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_detail (id INT AUTO_INCREMENT NOT NULL, gadget_id INT DEFAULT NULL, joke_id INT DEFAULT NULL, order_made_id INT DEFAULT NULL, quantity INT DEFAULT NULL, size VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, INDEX IDX_ED896F4684CDDC26 (gadget_id), INDEX IDX_ED896F4630122C15 (joke_id), INDEX IDX_ED896F46BB954D71 (order_made_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
